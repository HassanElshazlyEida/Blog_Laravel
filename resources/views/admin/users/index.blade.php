                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            @foreach($users as $key=>$user)
                                <tr>
                                    <td>
                                        <img src="@if(isset($user->profile->avatar)) {{asset("uploads/avatars/".$user->profile->avatar)}}@else {{asset("uploads/avatars/default.png")}} @endif" style="border-radius:50%;width:100px;height:100px" alt="{{$user->name}}" class="img-thumbnail">
                                    </td>
                                    <td>{{$user->name}}</td>
                                    <td>
